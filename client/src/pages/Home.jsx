    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
            ...
            <div className="relative overflow-hidden">
                ...
                <div className="relative px-4 py-20 mx-auto max-w-7xl sm:px-6 lg:px-8 fade-in">
                    <div className="text-center">
                        <div className="inline-flex items-center px-4 py-2 mb-8 text-sm font-semibold rounded-full text-primary bg-primary/10">
                        ...
                        <div className="flex flex-col items-center justify-center gap-4 mt-10 sm:flex-row">
                            {!user ? (
                                <>
                                    <Link
                                        to="/signup"
                                        className="flex items-center px-8 py-4 text-lg font-semibold text-white transition-all transform shadow-lg bg-primary rounded-xl hover:bg-indigo-700 hover:scale-105 hover:shadow-xl"
                                    >
                                    ...
                                    <Link
                                        to="/login"
                                        className="flex items-center px-8 py-4 text-lg font-semibold text-gray-700 transition-all transform bg-white border-2 border-gray-200 shadow-lg rounded-xl hover:bg-gray-50 hover:scale-105 hover:shadow-xl"
                                    >
                                        <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1" />
                                        </svg>
            ...
            <div className="py-16 bg-gradient-to-b from-white to-gray-50">
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="mb-12 text-center fade-in-up">
                        <h2 className="mb-4 text-4xl font-bold text-gray-900">Quick Access</h2>
                        ...
                        {quickLinks
                            ...
                            .map((link, index) => (
                                <Link
                                    key={index}
                                    to={link.path}
                                    className="relative p-6 transition-all transform bg-white shadow-lg group rounded-2xl hover:scale-105 hover:shadow-2xl card-hover fade-in-up"
            ...
            <div className="py-16 bg-white">
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="mb-12 text-center fade-in-up">
                        <h2 className="mb-4 text-4xl font-bold text-gray-900">Why Choose WashEase?</h2>
                    ...
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                        {features.map((feature, index) => (
                            <div
                                key={index}
                                className="p-6 transition-all border border-gray-100 shadow-md bg-gradient-to-br from-gray-50 to-white rounded-2xl hover:shadow-xl card-hover fade-in-up"
                                style={{ animationDelay: `${index * 0.1}s` }}
                            >
                ...
                <div className="py-20 bg-gradient-to-r from-primary to-purple-600">
                    <div className="max-w-4xl px-4 mx-auto text-center sm:px-6 lg:px-8">
                        ...
                        <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                            <Link
                                to="/signup"
                                className="flex items-center px-8 py-4 text-lg font-semibold transition-all transform bg-white shadow-lg text-primary rounded-xl hover:bg-gray-100 hover:scale-105"
                            >
                                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                                </svg>
